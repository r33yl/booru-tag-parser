...
export const colors = {
    // ===== Layout =====
    bg: "bg-neutral-900",
    pageMotion: "will-change-transform !transition-colors !duration-300",

    // ===== Text =====
    text: "text-neutral-100",
    secondaryText: "text-neutral-300",
    secondaryTextHover: "hover:text-white",
    textMotion: "will-change-transform !transition-colors !duration-200",
